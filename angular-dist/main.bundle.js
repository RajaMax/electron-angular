...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__product1_product1_component__ = __webpack_require__("./src/app/product1/product1.component.ts");
...
var routes = [
    ...
    { path: 'product1', component: __WEBPACK_IMPORTED_MODULE_4__product1_product1_component__["a" /* Product1Component */] }
];
...
module.exports = "<!-- <div (window:keypress)=\"doSomething($event)\">click me<div> -->\n<h1>Welcome GSM </h1>{{value}}\n<button *ngIf=\"online\" (click)=\"checkConnection()\">Online</button>\n<button *ngIf=\"!online\" (click)=\"checkConnection()\">offline</button>\n<a routerLink=\"/bill\">Bill (Ctrl+B)</a>\n<a routerLink=\"/product1\">Product (Ctrl+P)</a>\n<router-outlet></router-outlet>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data1_service__ = __webpack_require__("./src/app/data1.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_operator_timeInterval__ = __webpack_require__("./node_modules/rxjs/_esm5/operator/timeInterval.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(ds, router) {
        ...
        var menu = __WEBPACK_IMPORTED_MODULE_4_electron__["remote"].Menu.buildFromTemplate([{
                ...
                submenu: [{
                        ...
                        click: function () {
                            console.log("render");
                            _this.router.navigate(['/product1']);
                        },
                    },
                    {
                        role: 'toggledevtools'
    ...
    AppComponent.prototype.checkConnection = function () {
        ...
        this.ds.checkStatusCall().subscribe(function (res) {
            console.log("online");
            _this.online = true;
            console.log(__WEBPACK_IMPORTED_MODULE_5_rxjs_operator_timeInterval__["a" /* timeInterval */]);
            ...
            _this.online = false;
            console.log("this.online", _this.online);
            if (_this.check) {
                _this.check = false;
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__data1_service__["a" /* DataService1 */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data1_service__ = __webpack_require__("./src/app/data1.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bill_bill_component__ = __webpack_require__("./src/app/bill/bill.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__product1_product1_component__ = __webpack_require__("./src/app/product1/product1.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__bill_bill_component__["a" /* BillComponent */],
                __WEBPACK_IMPORTED_MODULE_8__product_product_component__["a" /* ProductComponent */],
                __WEBPACK_IMPORTED_MODULE_10__product1_product1_component__["a" /* Product1Component */],
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_5__data1_service__["a" /* DataService1 */]],
...
var DataService = /** @class */ (function () {
    ...
    */
    ...
    DataService.prototype.addCloudProduct = function (data) {
        var _this = this;
        if (this.notAddCall) {
...
/***/ "./src/app/data1.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DataService1; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_nedb__ = __webpack_require__("./node_modules/nedb/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_nedb___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_nedb__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
...
var DataService1 = /** @class */ (function () {
    ...
    * @memberof AuthService
    */
    DataService1.prototype.checkOnline = function () {
        var _this = this;
        console.log("navigation" + navigator.onLine);
        this.appOnline = navigator.onLine;
        if (this.appOnline) {
            var nonCloduData = [];
            this.getNonCloudData().then(function (arrayData) {
                console.log(arrayData);
                nonCloduData = arrayData;
                if (_this.appOnline) {
                    nonCloduData.forEach(function (element) {
    ...
    DataService1.prototype.toMoveCloud = function (data) {
        var _this = this;
        console.log("move");
        console.log(data);
        if (data.status === "add") {
            this.addCloudProduct(data).subscribe(function (data1) {
                _this.changeStatus(data, data1._id).then(function () {
                });
            });
        }
            ...
            this.deleteCloudProduct(data.cloud_id).subscribe(function (data1) {
                _this.deleteRecord(data)
                    .then(function (docs) {
                })
                    .catch(function (err) { return console.error(err); });
            });
    ...
    DataService1.prototype.getData = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var obj = {};
            //var obj = {status: { $nin: ['delete'] }};
    ...
    DataService1.prototype.getNonCloudData = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.db.find({ isCloud: false }, function (err, docs) {
                if (err)
    ...
    DataService1.prototype.getColudData = function () {
        var url = this.endPoint + "/product";
        return this.http.get(url)
            .map(function (res) {
            if (res.code === 403) {
    ...
    DataService1.prototype.deleteRecord = function (record) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.db.remove({ _id: record._id }, function (err, numRemoved) {
                if (err)
    ...
    DataService1.prototype.addRecord = function (record) {
        var _this = this;
        record.isCloud = false;
        record.status = "add";
        record.cloud_id = "";
    ...
    DataService1.prototype.addCloudProduct = function (data) {
        var _this = this;
        if (this.notAddCall) {
            this.notAddCall = false;
            var url = this.endPoint + "/product";
    ...
    ;
    DataService1.prototype.deleteCloudProduct = function (id) {
        var url = this.endPoint + "/product/" + id;
        return this.http
            .delete(url, {
            observe: "response"
    ...
    ;
    DataService1.prototype.changeStatus = function (data, cloudId) {
        var _this = this;
        console.log("changeStatus");
        console.log("cloudId " + cloudId);
        var obj = {};
    ...
    DataService1.prototype.changeStatusforDelete = function (data) {
        var _this = this;
        console.log("delete changeStatus");
        var obj = { isCloud: false, status: "delete" };
        return new Promise(function (resolve, reject) {
    ...
    DataService1.prototype.checkStatusCall = function () {
        console.log("delete changeStatus");
        var obj = { isCloud: false, status: "delete" };
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.addProduct = function () {
        ...
        this.ds.addRecord(this.myGroup.value)
            ...
            if (navigator.onLine) {
                _this.ds.addCloudProduct(_this.myGroup.value).subscribe(function (data) {
                    console.log(data);
    ...
    ProductComponent.prototype.toMoveCloud = function (data) {
        ...
        console.log(data);
        if (data.status === "add") {
            this.ds.addCloudProduct(data).subscribe(function (data1) {
...
/***/ "./src/app/product1/product1.component.css":
/***/ (function(module, exports) {
...
var Product1Component = /** @class */ (function () {
    function Product1Component(ds, router, http) {
        this.ds = ds;
        this.router = router;
        this.http = http;
        this.records = [];
    ...
    Product1Component.prototype.handleKeyboardEvent = function (event) {
        if (event.code === "KeyS" && event.ctrlKey) {
            this.addProduct();
        }
    };
    ...
    Product1Component.prototype.initialFunciton = function () {
        var _this = this;
        console.log("initial");
        this.ds.getNonCloudData().then(function (arrayData) {
            console.log(arrayData);
            ...
            if (navigator.onLine) {
                _this.nonCloduData.forEach(function (element) {
                    _this.toMoveCloud(element);
                    _this.refreshLocalRecord();
                });
            }
        }).catch(function (err) { return console.error(err); });
        this.refreshLocalRecord();
    };
    Product1Component.prototype.refreshLocalRecord = function () {
        var _this = this;
        this.ds.getData().then(function (docs) {
            _this.records = docs;
        }).catch(function (err) { return console.error(err); });
    };
    Product1Component.prototype.addProduct = function () {
        var _this = this;
        this.ds.addRecord(this.myGroup.value)
            .then(function (docs) {
            console.log("navigator " + navigator.onLine);
    ...
    Product1Component.prototype.delete = function (record) {
        var _this = this;
        if (record.cloud_id) {
            this.ds.changeStatusforDelete(record)
                .then(function (docs) {
    ...
    Product1Component.prototype.toMoveCloud = function (data) {
        var _this = this;
        console.log("move");
        console.log(data);
        if (data.status === "add") {
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [KeyboardEvent]),
        __metadata("design:returntype", void 0)
    ], Product1Component.prototype, "handleKeyboardEvent", null);
    Product1Component = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-product1',
            template: __webpack_require__("./src/app/product1/product1.component.html"),
            styles: [__webpack_require__("./src/app/product1/product1.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__data1_service__["a" /* DataService1 */],
            __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */],
            __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["a" /* HttpClient */]])
